const challengeData={
  month:{title:'Month-end slowing you down?',copy:'Close the books faster with AI-powered automation that reduces manual work and keeps your finance function moving as your business grows.',items:['Save time with specialised AI agents across workflows.','Automate accounts payable, eliminations and consolidations.','Reduce human errors as transaction volumes increase.']},
  compliance:{title:'Growth outpacing your finance system?',copy:'Build for what’s next with a flexible platform that adapts as your business evolves, from entering new markets to managing growing complexity.',items:['Support multi-entity, multi-currency growth.','Add capability and industry specific add-ons as needs change.','Adapt at pace, without starting again.']},
  scale:{title:'Delivering end-of-day reports, not insights?',copy:'Turn financial data into the insight you need to understand performance, spot opportunities and make faster, more confident decisions.',items:['Get real-time visibility across your business.','See what’s driving performance without waiting for month-end.','Act on insights with AI-powered analysis.']},
  implementation:{title:'Concerned about the cost of change?',copy:'Move to Sage Intacct with confidence. Expert-led implementation minimises disruption, so you can start seeing the value from your investment fast.',items:['Structured data migration.','Role-based training.','Dedicated support teams.','ROI and Implementation costed upfront.']}
};
const featureData={
...
const faqs=[
 ...
 ['How do Sage Intacct Integrations connect with other business systems?','Sage Intacct Integrations connect your finance data with hundreds of business applications across your organisation, including operations, CRM, payroll and reporting. This creates a single source of truth, reducing manual work and giving teams better visibility for faster decision-making. Choose from prebuilt integrations in the Sage Intacct Marketplace, or build custom integrations using our open API architecture.'],
